...
public class ZCComponentVirtualWeb extends ZCManagerWeb {
	...
	protected static IZCLogger logger = ZCLoggerFactory
			.getLogger(ZCComponentVirtualWeb.class);
	...
	public void goToPage(String pageName, String beanName, Object beanValue,
		...
		String target = resultView.getTargetName();
			...
			try {
				Object  instance =  ReflectManager
						.creatInstanceByClassName(target);
				if (ReflectManager.getNbrOfParameter(instance,
						resultView.getMethodeName()) == 0) {

					Object page = ReflectManager.executeMethode(instance, resultView.getMethodeName());
					ZCPage currentPage = null;
					if(ZCPage.class.isInstance(page ))
					{
						 currentPage = (ZCPage) page;
	...
	/**
	 * <p>methode that write the a ZCPage and show it in to the browser</p>
	 * @param currentPage
	 * @throws Exception
	 */
