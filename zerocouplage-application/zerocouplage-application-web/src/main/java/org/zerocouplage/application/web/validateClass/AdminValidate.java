package org.zerocouplage.application.web.validateClass;
...
import org.zerocouplage.application.web.business.BD;
	...
	public Map<String, String> validate(Map<Object, Object> ViewValue,
		...
		try {
			...
			while(rs.next()){
				...
				if(!rs.getString("password").equals(Ibean.getPassword_admin())){
