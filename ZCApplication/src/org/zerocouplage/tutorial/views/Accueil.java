...
public class Accueil implements ZCView {
	...
	public ZCPage executerResultat(UserBeanOut user) throws IOException, ZCExceptionConfig, ZCCompNotFoundException, Exception{
		userOut= user;
		return display();
	}
	...
	public ZCPage display() throws IOException, ZCExceptionConfig,
		...
		labelOfwelcome.setLabel("Vous êtes authentifié avec succes cher(e) "+userOut.getLogin());
